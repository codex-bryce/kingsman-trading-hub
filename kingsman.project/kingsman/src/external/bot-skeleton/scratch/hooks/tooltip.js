...
window.Blockly.Tooltip.show_ = () => {
  ...
  if (!window.Blockly.Tooltip.blocked_) {
    ...
    for (
      params = window.Blockly.Tooltip.element_.tooltip;
      typeof params === "function";

    )
      params = params();
    params = window.Blockly.utils.string.wrap(
      params,
    ...
    if (
      last_y + window.Blockly.Tooltip.DIV.offsetHeight >
      client_height + window.scrollY
    ) {
      last_y -=
