...
window.Blockly.Blocks.trade_definition_alternate_markets = {
  init() {
    this.jsonInit({
      message0: localize(
        "Alternate markets (Continuous Indices only): {{ checkbox }} {{ every }} {{ runs }}",
        {
          checkbox: "%1",
          every: "%2",
          runs: "%3 %4",
...
window.Blockly.JavaScript.javascriptGenerator.forBlock.trade_definition_alternate_markets =
  (block) => {
