...
Blockly.Blocks.last_digits_condition = {
  ...
  definition() {
    return {
      ...
      tooltip: localize(
        "Checks if last N digits satisfy the given condition against a digit",
      ),
  ...
  meta() {
    return {
      ...
      description: localize(
        "Checks if the last N digits meet the specified condition.",
      ),
    };
  },
...
Blockly.JavaScript.javascriptGenerator.forBlock.last_digits_condition = (
  block,
) => {
