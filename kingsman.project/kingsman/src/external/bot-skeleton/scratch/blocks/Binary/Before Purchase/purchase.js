...
window.Blockly.Blocks.purchase = {
  ...
  definition() {
    return {
      message0: localize("Purchase {{ contract_type }}", {
        contract_type: "%1",
      }),
      args0: [
        {
