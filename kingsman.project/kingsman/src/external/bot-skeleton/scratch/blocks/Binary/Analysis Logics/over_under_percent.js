...
Blockly.Blocks.over_under_percent = {
  ...
  definition() {
    return {
      ...
      tooltip: localize(
        "Returns percentage of digits above threshold from last N ticks",
      ),
  ...
  meta() {
    return {
      ...
      description: localize(
        "Percentage of digits above/below specified digit from last N ticks",
      ),
    };
  },
...
Blockly.JavaScript.javascriptGenerator.forBlock.over_under_percent = (
  block,
) => {
