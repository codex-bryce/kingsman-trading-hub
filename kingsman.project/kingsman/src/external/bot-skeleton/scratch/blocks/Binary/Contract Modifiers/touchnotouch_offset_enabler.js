...
window.Blockly.Blocks.touchnotouch_offset_enabler = {
  ...
  definition() {
    return {
      ...
      tooltip: localize(
        "Enable or disable Touch/NoTouch barrier offset changer.",
      ),
  ...
  meta() {
    return {
      ...
      description: localize(
        "This block enables or disables the barrier offset changer feature.",
      ),
    };
  },
...
window.Blockly.JavaScript.javascriptGenerator.forBlock.touchnotouch_offset_enabler =
  (block) => {
