...
window.Blockly.Blocks.barrier_settings = {
  init() {
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new window.Blockly.FieldNumber(1, -999999, 999999, 0.01),
        "BARRIER1",
      );
  ...
  definition() {
    return {
      ...
      tooltip: localize(
        "Configure first and second barriers (absolute or relative).",
      ),
  ...
  meta() {
    return {
      ...
      description: localize(
        "Set barrier types and values used by your strategy.",
      ),
    };
  },
...
window.Blockly.JavaScript.javascriptGenerator.forBlock.barrier_settings = (
  block,
) => {
