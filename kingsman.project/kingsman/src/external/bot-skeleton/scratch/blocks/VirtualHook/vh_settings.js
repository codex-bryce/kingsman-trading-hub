...
window.Blockly.Blocks.vh_settings = {
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new window.Blockly.FieldNumber(1.5, 0, Infinity, 0.1),
        "MARTINGALE_FACTOR",
      );
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new window.Blockly.FieldNumber(3, 0, Infinity, 1),
        "MAX_STEPS",
      );
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new window.Blockly.FieldNumber(1, 0, Infinity, 1),
        "MIN_TRADES_REAL",
      );
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new window.Blockly.FieldNumber(50, 0, Infinity, 0.01),
        "TAKE_PROFIT",
      );
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new window.Blockly.FieldNumber(5, 0, Infinity, 0.01),
        "STOP_LOSS",
      );
  },
  definition() {
  ...
  meta() {
    return {
      ...
      description: localize(
        "Set VH martingale factor, steps, min trades on real, TP and SL.",
      ),
    };
  },
};
...
window.Blockly.JavaScript.javascriptGenerator.forBlock.vh_settings = function (
  block,
) {
