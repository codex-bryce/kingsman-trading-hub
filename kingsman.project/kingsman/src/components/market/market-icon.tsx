...
const MARKET_ICONS = {
  FRXAUDCAD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexAudcadIcon,
    })),
  ),
  FRXAUDCHF: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexAudchfIcon,
    })),
  ),
  FRXAUDJPY: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexAudjpyIcon,
    })),
  ),
  FRXAUDNZD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexAudnzdIcon,
    })),
  ),
  FRXAUDPLN: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexAudsgdIcon,
    })),
  ),
  FRXAUDUSD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexAudusdIcon,
    })),
  ),
  FRXBROUSD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexCadchfIcon,
    })),
  ),
  FRXEURAUD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexEuraudIcon,
    })),
  ),
  FRXEURCAD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexEurcadIcon,
    })),
  ),
  FRXEURCHF: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexEurchfIcon,
    })),
  ),
  FRXEURGBP: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexEurgbpIcon,
    })),
  ),
  FRXEURJPY: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexEurjpyIcon,
    })),
  ),
  FRXEURNZD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexEurnzdIcon,
    })),
  ),
  FRXEURUSD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexEurusdIcon,
    })),
  ),
  FRXGBPAUD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexGbpaudIcon,
    })),
  ),
  FRXGBPCAD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexGbpcadIcon,
    })),
  ),
  FRXGBPCHF: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexGbpchfIcon,
    })),
  ),
  FRXGBPJPY: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexGbpjpyIcon,
    })),
  ),
  FRXGBPNOK: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexGbpnokIcon,
    })),
  ),
  FRXGBPUSD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexGbpusdIcon,
    })),
  ),
  FRXGBPNZD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexGbpnzdIcon,
    })),
  ),
  FRXNZDJPY: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexNzdjpnIcon,
    })),
  ),
  FRXNZDUSD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexNzdusdIcon,
    })),
  ),
  FRXUSDCAD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexUsdcadIcon,
    })),
  ),
  FRXUSDCHF: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexUsdchfIcon,
    })),
  ),
  FRXUSDJPY: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexUsdjpyIcon,
    })),
  ),
  FRXUSDNOK: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexUsdnokIcon,
    })),
  ),
  FRXUSDPLN: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexUsdplnIcon,
    })),
  ),
  FRXUSDSEK: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexUsdsekIcon,
    })),
  ),
  FRXUSDMXN: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketForexUsdmxnIcon,
    })),
  ),
  FRXXAGUSD: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
  ...
  RDBEAR: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketDerivedBearIcon,
    })),
  ),
  RDBULL: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
      default: module.MarketDerivedBullIcon,
    })),
  ),
  STPRNG: lazy(() =>
    import("@deriv/quill-icons/Markets").then((module) => ({
  ...
  unknown: lazy(() =>
    import("@deriv/quill-icons/Illustrative").then((module) => ({
...
export const MarketIcon = ({
  ...
  const Icon =
    MARKET_ICONS[type?.toUpperCase() as keyof typeof MARKET_ICONS] ||
    MARKET_ICONS.unknown;
