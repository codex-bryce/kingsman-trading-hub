...
export const IDV_ERROR_STATUS: TIDVErrorStatus = Object.freeze({
  ...
  EmptyStatus: {
    code: "EmptyStatus",
    message: (
      <Localize i18n_default_text="The verification status was empty, rejected for lack of information." />
    ),
  },
  Expired: {
    code: "Expired",
    message: (
      <Localize i18n_default_text="Your identity document has expired." />
    ),
  },
  InformationLack: {
  ...
  RejectedByProvider: {
    ...
    message: (
      <Localize i18n_default_text="The document was rejected by the Provider." />
    ),
  },
  Underage: {
    code: "Underage",
...
export const ONFIDO_ERROR_STATUS: TOnfidoErrorStatus = Object.freeze({
  ...
  CompromisedDocument: {
    ...
    message: (
      <Localize i18n_default_text="Your document failed our verification checks." />
    ),
  },
  DataComparisonDateOfBirth: {
    code: "DataComparisonDateOfBirth",
    message: (
      <Localize i18n_default_text="The date of birth on your document doesn’t match your profile." />
    ),
  },
  ...
  DataComparisonDocumentNumbers: {
    ...
    message: (
      <Localize i18n_default_text="Your document appears to be invalid." />
    ),
  },
  ...
  DataComparisonName: {
    ...
    message: (
      <Localize i18n_default_text="The name on your document doesn’t match your profile." />
    ),
  },
  ...
  DataValidationNoDocumentNumbers: {
    ...
    message: (
      <Localize i18n_default_text="The serial number of your document couldn’t be verified." />
    ),
  },
  DuplicatedDocument: {
    code: "DuplicatedDocument",
    message: (
      <Localize i18n_default_text="Your verification documents were already used for another account." />
    ),
  },
  Expired: {
    code: "Expired",
  ...
  ImageIntegrityConclusiveDocumentQualityCornerRemoved: {
    ...
    message: (
      <Localize i18n_default_text="Your document appears to be damaged or cropped." />
    ),
  },
  ImageIntegrityConclusiveDocumentQualityDigitalDocument: {
    code: "ImageIntegrityConclusiveDocumentQualityDigitalDocument",
    message: (
      <Localize i18n_default_text="Your document appears to be a digital document." />
    ),
  },
  ...
  SelfieRejected: {
    code: "SelfieRejected",
    message: (
      <Localize i18n_default_text="Your selfie does not match your document." />
    ),
  },
  ...
  VisualAuthenticityOriginalDocumentPresentDocumentOnPrintedPaper: {
    ...
    message: (
      <Localize i18n_default_text="Your document appears to be a printed copy." />
    ),
  },
  VisualAuthenticityOriginalDocumentPresentPhotoOfScreen: {
    code: "VisualAuthenticityOriginalDocumentPresentPhotoOfScreen",
    message: (
      <Localize i18n_default_text="Your document appears to be a photo of a device screen." />
    ),
  },
  ...
  VisualAuthenticityOriginalDocumentPresentScreenshot: {
    ...
    message: (
      <Localize i18n_default_text="Your document appears to be a screenshot." />
    ),
  },
