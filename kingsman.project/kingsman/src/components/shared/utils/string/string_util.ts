...
export const compareBigUnsignedInt = (
  a: number,
...
export const numberToString = (n?: number | string | null) =>
...
export const formatInput = (
  ...
  if (
    separator_index !== -1 &&
    input_count < format_count &&
    input_string.length - 1 >= separator_index
  ) {
    return (
      input_string.slice(0, separator_index) +
      separator +
      input_string.slice(separator_index)
    );
  }
