...
const ContractStageText: React.FC<TContractStageText> = ({
  contract_stage,
}) => {
  const stage =
    contract_stage !== undefined ? contract_stage : contract_stages.NOT_RUNNING;
  ...
  switch (stage) {
    ...
    case contract_stages.PURCHASE_SENT:
      return (
        <Localize i18n_default_text={text_contract_stages.PURCHASE_SENT} />
      );
    case contract_stages.PURCHASE_RECEIVED:
      return (
        <Localize i18n_default_text={text_contract_stages.PURCHASE_RECEIVED} />
      );
    ...
    case contract_stages.CONTRACT_CLOSED:
      return (
        <Localize i18n_default_text={text_contract_stages.CONTRACT_CLOSED} />
      );
