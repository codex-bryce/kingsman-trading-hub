...
const TableCell = ({
  ...
  return (
    <div
      className={classNames(`${PARENT_CLASS}__table-cell`, ...extra_classes)}
    >
...
const TableHeader = ({ columns }: { columns: TColumn[] }) => (
  <div
    className={classNames(
      `${PARENT_CLASS}__table-row`,
      `${PARENT_CLASS}__table-header`,
    )}
  >
    {columns?.map((column) => (
      <TableCell
        ...
        extra_classes={[
          column.extra_class
            ? `${PARENT_CLASS}__table-cell${column.extra_class}`
            : "",
        ]}
        label={column.label}
        loader={false}
    ...
    >
          ...
          if (type === transaction_elements.CONTRACT) {
            return (
              <div
                ...
                key={
                  data?.display_transaction_ids?.buy ??
      ...
      >
        ...
        <div className={`${PARENT_CLASS}__table-row`}>
          ...
          <TableCell
            label={result?.lost_contracts}
            extra_classes={[`${PARENT_CLASS}__loss`]}
          />
          <TableCell
            label={
              <div
