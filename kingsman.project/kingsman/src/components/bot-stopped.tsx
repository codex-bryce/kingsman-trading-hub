  ...
  return (
    ...
    >
      ...
      <Text as="p" align="left" size="xs" color="prominent">
        <Localize i18n_default_text="The bot has stopped because the trading connection was interrupted. If a trade was already opened, you can check it on the Reports page." />
      </Text>
    </Dialog>
  );
});
