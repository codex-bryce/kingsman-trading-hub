...
const Draggable: React.FC<TDraggableProps> = ({
  ...
  const [boundaryRef, setBoundaryRef] = useState(
    document.querySelector(
      boundary ?? DRAGGABLE_CONSTANTS.BODY_REF,
    ) as HTMLElement | null,
  );
  ...
  const handleMouseDown = (
    ...
    const initialSelfRight =
      draggableRef.current?.getBoundingClientRect()?.right ?? size.width;
    const initialSelfBottom =
      draggableRef.current?.getBoundingClientRect()?.bottom ?? size.height;
    ...
    const handleResize = (
      ...
      setPosition((prev) => {
        ...
        return {
          x: newWidth <= minWidth ? prev.x : maxX,
          y: newHeight <= minHeight ? prev.y : maxY,
        };
      });
        ...
        {enableResizing && (
          <>
            <div
              ...
              onKeyDown={(e: React.KeyboardEvent<HTMLElement>) =>
                e.key === "Enter" &&
                handleMouseDown(null, DRAGGABLE_CONSTANTS.MOVE)
              }
            ...
            <div
              ...
              onMouseDown={(e) =>
                handleMouseDown(e, DRAGGABLE_CONSTANTS.BOTTOM)
              }
              tabIndex={0}
            />
            <div
            ...
            <div
              ...
              onMouseDown={(e) =>
                handleMouseDown(e, DRAGGABLE_CONSTANTS.TOP_RIGHT)
              }
              tabIndex={0}
            />
            <div
              ...
              onMouseDown={(e) =>
                handleMouseDown(e, DRAGGABLE_CONSTANTS.BOTTOM_RIGHT)
              }
              tabIndex={0}
            />
            <div
              ...
              onMouseDown={(e) =>
                handleMouseDown(e, DRAGGABLE_CONSTANTS.BOTTOM_LEFT)
              }
              tabIndex={0}
            />
            <div
              ...
              onMouseDown={(e) =>
                handleMouseDown(e, DRAGGABLE_CONSTANTS.TOP_LEFT)
              }
              tabIndex={0}
            />
          </>
