...
export const NotificationContent: React.FC<TNotificationContent> = ({
  message,
  primary_action,
  closeToast,
}) => {
  ...
  return (
    <div className="notification-content" data-testid="dt_bot_notification">
      <div>{message}</div>
      {primary_action && (
        <button onClick={() => primary_action.onClick(closeToast)}>
...
export const botNotification = (
  ...
  return toast(
    ...
    ),
    {
      ...
      hideProgressBar:
        custom_style?.hideProgressBar ?? notification_style.hideProgressBar,
      closeOnClick:
        custom_style?.closeOnClick ?? notification_style.closeOnClick,
      pauseOnHover:
        custom_style?.pauseOnHover ?? notification_style.pauseOnHover,
      pauseOnFocusLoss:
        custom_style?.pauseOnFocusLoss ?? notification_style.pauseOnFocusLoss,
