...
import {
  help_content_config,
  help_content_types,
} from "@/utils/help-content/help-content.config";
    ...
    <React.Fragment>
      <div className="flyout__help-header" data-testid="dt_flyout_help_base">
        <button className="dc-btn flyout__button-back" onClick={onBackClick}>
          <LabelPairedArrowLeftCaptionRegularIcon
            height="16px"
            width="16px"
      ...
      <div className="flyout__help-content">
        {block_help_component &&
          block_help_component.map((component, index) => {
            ...
            const example_node = examples.find(
      ...
      {!is_search_flyout &&
        !(should_previous_disable && should_next_disable) && (
