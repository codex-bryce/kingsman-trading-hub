...
export type TRowRenderer = (
  params: Partial<TMobileRowRenderer>,
) => React.ReactNode;
...
const DataListRow = ({
  ...
  const debouncedHideDetails = useDebounce(
  ...
  return (
    <div
      ...
      style={{ paddingBottom: `${row_gap || 0}px` }}
    >
      {destination_link ? (
        <NavLink
