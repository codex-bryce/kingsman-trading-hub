...
const WALLET_ICONS = {
  IcWalletDerivDemoLight: lazy(() =>
    import("@deriv/quill-icons/Logo").then((module) => ({
  ...
  IcWalletXrpLight: lazy(() =>
    import("@deriv/quill-icons/PaymentMethods").then((module) => ({
...
export const WalletIconList = ({
  ...
  const Icon =
    WALLET_ICONS[type as keyof typeof WALLET_ICONS] || WALLET_ICONS.unknown;
