...
const MultiplierCardBody = ({
  ...
  const { take_profit, stop_loss } = getLimitOrderAmount(
    contract_update || limit_order,
  );
    ...
    <React.Fragment>
      ...
      >
        ...
        {has_progress_slider && is_mobile && !is_sold && (
          <ContractCardItem className="dc-contract-card__date-expiry">
            {progress_slider}
          </ContractCardItem>
        )}
