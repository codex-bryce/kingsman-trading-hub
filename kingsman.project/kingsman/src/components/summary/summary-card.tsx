  ...
  ({
    ...
    return (
      <div
        className={classNames("db-summary-card", {
          ...
          "db-summary-card--inactive":
            is_contract_inactive && !is_contract_loading && !contract_info,
          "db-summary-card--completed": is_contract_completed,
          "db-summary-card--completed-mobile":
            is_contract_completed && !isDesktop,
      ...
      >
        ...
        {is_bot_running && (
          <ContractCardLoader speed={2} contract_stage={contract_stage} />
        )}
        ...
        {!is_contract_loading && !contract_info && !is_bot_running && (
          <Text as="p" align="center" lineHeight="s" size="xs">
            ...
            <strong className="summary-panel-inactive__strong">
              {localize("Run")}
            </strong>
