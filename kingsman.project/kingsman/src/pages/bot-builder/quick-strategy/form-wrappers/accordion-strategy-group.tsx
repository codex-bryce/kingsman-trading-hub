...
export const DescriptionContent = ({
  ...
  const content_data: TDescriptionItem[] | string = Array.isArray(item)
    ? item
    : item.slice(1);
  return (
    <>
    ...
    return (
      <>
        {Array.isArray(grouped_objects_by_title) &&
          (grouped_objects_by_title as TDescriptionItem[][]).map(
              ...
              return (
                <Accordion
                  ...
                  content_data={{
                    ...
                    content: (
                      <DescriptionContent item={data} font_size={font_size} />
                    ),
                  }}
