...
const StrategyTemplatePicker = observer(
  ({ setCurrentStep, setSelectedTradeType }: TStrategyTemplatePicker) => {
            ...
            onClick={() => {
              ...
              setTimeout(() => {
                const tutorialsSection =
                  document.getElementById("id-tutorials");
                if (tutorialsSection) {
                  tutorialsSection.scrollIntoView({
                    behavior: "smooth",
                    block: "nearest",
                  });
                }
