...
export const ToolboxItems = () =>
  ReactDomServer.renderToStaticMarkup(
    <Xml xmlns="http://www.w3.org/1999/xhtml" id="toolbox">
      ...
      <Category
        id="sell_conditions"
        name={localize("Sell conditions (optional)")}
      >
      ...
      <Category
        id="trade_results"
        name={localize("Restart trading conditions")}
      >
      ...
      <Category id="analysis" name={localize("Analysis")}>
        ...
        <Category
          name={localize("Tick and candle analysis")}
          id="tick_analysis"
        >
      ...
      <Category id="utility" name={localize("Utility")}>
        <Category
          name={localize("Custom functions")}
          id="custom_functions"
          dynamic="PROCEDURE"
        />

        <Category
          name={localize("Variables")}
          id="variables"
          dynamic="VARIABLE"
        />
      ...
      <Category
        name={localize("Barrier Settings")}
        id="barrier_settings_category"
      >
