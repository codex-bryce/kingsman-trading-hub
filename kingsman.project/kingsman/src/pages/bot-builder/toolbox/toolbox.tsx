        ...
        <div id="gtm-toolbox" className="db-toolbox__content">
          ...
          >
            ...
            <div className="db-toolbox__category-menu">
              {toolbox_dom &&
                Array.from(toolbox_dom.childNodes as HTMLElement[]).map(
                  (category, index) => {
                    if (category.tagName.toUpperCase() === "CATEGORY") {
                      const has_sub_category = hasSubCategory(
                        category.children,
                      );
                      const is_sub_category_open =
                        sub_category_index.includes(index);
                      return (
                        <div
                        ...
                        >
                          ...
                          >
                            <div className="db-toolbox__category-text">
                              <div className="db-toolbox__label">
                                {localize(
                                  category.getAttribute("name") as string,
                                )}
                              </div>
                              {has_sub_category && (
                                <div
                          ...
                          {has_sub_category &&
                            is_sub_category_open &&
                            (
                              Array.from(category.childNodes) as HTMLElement[]
                            ).map((subCategory) => {
                              return (
                                <div
