...
const BotBuilder = observer(() => {
  const { dashboard, app, run_panel, toolbar, quick_strategy, blockly_store } =
    useStore();
  ...
  const removeBlockChangeListener = () => {
    ...
    window.Blockly?.derivWorkspace?.removeChangeListener(
    ...
    <>
      <div
        className={classNames("bot-builder", {
          "bot-builder--active":
            active_tab === DBOT_TABS.BOT_BUILDER && !is_preview_on_popup,
      ...
      {active_tab === DBOT_TABS.BOT_BUILDER && (
        <BotBuilderTourHandler is_mobile={!isDesktop} />
      )}
