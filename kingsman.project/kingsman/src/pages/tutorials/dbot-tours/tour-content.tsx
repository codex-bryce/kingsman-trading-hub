...
export const getTourDialogInfo = (is_mobile: boolean) => {
  return is_mobile ? (
    ...
    <Localize
      ...
      i18n_default_text="Learn how to build a bot with a simple strategy."
    />
  );
};
...
export const onboarding_tour_header = (
  <Localize
    key="onboarding-tour-header"
    i18n_default_text="Welcome to Deriv Bot"
  />
);
