...
const EvenStrategy: React.FC<EvenStrategyProps> = ({ onBack }) => {
  const handleDownload = () => {
    const content = `EVEN STRATEGY @WWW.SOLDSOURCECODE.COM
...
USE WWW.SOLDSOURCECODE.COM TO TRADE`;
      ...
      <div className="strategy-viewer__content">
        ...
        <div className="strategy-viewer__document">
          <h1 className="strategy-viewer__title">
            EVEN STRATEGY @WWW.SOLDSOURCECODE.COM
          </h1>
          ...
          <section className="strategy-section">
            ...
            <div className="strategy-subsection">
              <ul className="strategy-list">
                <li>
                  <strong>BLUE & GREEN SHOULD BE ON EVEN DIGITS</strong> - Both
                  the blue (2nd most appearing) and green (most appearing) bars
                  must be positioned on even digits (0, 2, 4, 6, 8).
                </li>
                <li>
                  <strong>BOTH G & B BAR SHOULD HAVE %GES ABOVE 11</strong> -
                  Both green and blue bars should have percentages above 11%.
                </li>
                <li>
                  <strong>
                    RED & YELLOW BAR SHOULD EITHER BE ON ODD DIGITS, OR ODD/EVEN
                  </strong>{" "}
                  - The red (least appearing) and yellow (2nd least appearing)
                  bars can be on odd digits or a combination of odd/even.
                </li>
                <li>
                  <strong>RED BAR %GE: 8.6 AND BELOW</strong> - The red bar
                  percentage should be 8.6% or lower.
                </li>
                <li>
                  <strong>YELLOW BAR %GE: 9.5 AND BELOW</strong> - The yellow
                  bar percentage should be 9.5% or lower.
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="strategy-section">
            ...
            <div className="strategy-subsection">
              <p className="strategy-text">
                <strong>
                  WAIT FOR TICK POINTER TO PICK THE ODD DIGIT AMONG THE LEAST
                  APPEARING PAIR (RED & YELLOW),
                </strong>{" "}
                if within the next{" "}
                <strong>
                  3 TICKS AN EVEN DIGIT IS PICKED, ENTER IMMEDIATELY.
                </strong>
              </p>

              <div className="strategy-note">
                <strong>NB:</strong> AFTER 3 TO 7 RUNS MAX ON PROFITS, STOP THE
                BOT TO CONFIRM THE MARKET CONDITIONS AND WAIT FOR ANOTHER ENTRY
                TRIGGER.
              </div>
            </div>
          </section>
          ...
          <section className="strategy-section">
            ...
            <div className="strategy-subsection">
              <ul className="strategy-list">
                <li>
                  <strong style={{ color: "#ef4444" }}>RED:</strong> LEAST
                  APPEARING DIGIT
                </li>
                <li>
                  <strong style={{ color: "#f59e0b" }}>YELLOW:</strong> 2ND
                  LEAST APPEARING
                </li>
                <li>
                  <strong style={{ color: "#10b981" }}>GREEN:</strong> MOST
                  APPEARING
                </li>
                <li>
                  <strong style={{ color: "#3b82f6" }}>BLUE:</strong> 2ND MOST
                  APPEARING
                </li>
              </ul>
            </div>
