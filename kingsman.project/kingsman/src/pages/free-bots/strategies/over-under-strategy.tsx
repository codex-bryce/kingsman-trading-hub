        ...
        <div className="strategy-viewer__document">
          ...
          <section className="strategy-section">
            ...
            <div className="strategy-subsection">
              ...
              <ul className="strategy-list">
                <li>
                  Digit 0,1,2 & 3 should have percentages below 10% (decreasing)
                  and a red or yellow bar should be among them. (These
                  conditions are for over prediction 3. If only 0,1 & 2 are
                  having %ges below 10, you can opt to trade over prediction 0,1
                  or 2)
                </li>
                <li>
                  Digit 4 to 9 should have at least two, 11% and above. The blue
                  & green bar should be within the same range.
                </li>
              </ul>
              ...
              <div className="strategy-detail">
                ...
                <p className="strategy-text">
                  Wait for the tick pointer to pick the least appearing among
                  digit 1,2 & 3, if within the next 1 tick the pointer picks any
                  digit from 4 to 9, enter immediately.
                </p>
              </div>
          ...
          <section className="strategy-section">
            ...
            <div className="strategy-subsection">
              ...
              <ul className="strategy-list">
                <li>
                  Digit 9,8,7 & 6 should have percentages below 10% (decreasing)
                  and a red or yellow bar should be among them. (These
                  conditions are for under prediction 6. If only 9,8 &7 are
                  having %ges below 10, you can opt to trade under prediction
                  9,8 or 7)
                </li>
                <li>
                  Digit 0 to 5 should have at least two, 11% and above. The blue
                  & green bar should be within the same range.
                </li>
              </ul>
              ...
              <div className="strategy-detail">
                ...
                <p className="strategy-text">
                  Wait for the tick pointer to pick the least appearing among
                  digit 8,7 & 6. If within the next 1 tick the pointer picks any
                  digit from 0 to 4, enter immediately.
                </p>
              </div>
          ...
          <div className="strategy-footer">
            <p
              ...
              style={{ color: "#ffffff", margin: "0.5rem 0" }}
            >
              "The strategy gives you direction, but discipline gives you
              results. Practice patiently, execute cleanly, and trust the
              process."
            </p>
            <p
              className="strategy-text"
