...
const SoldSourceCodeStrategies: React.FC = () => {
  const handleDownload = () => {
    // Create PDF content
    const content = `Sold Source code STRATEGIES
...
Recommended bots to use: "over 1 with over 3 recovery", "ALPHA TRADER pro", "Hit & run (set your entry 
...
Recommended bots to use: "QUANTUM OVER pro", "ALPHA TRADER pro", "Hit & run (set your entry point to 0 or 1 )". 
...
Recommended bots to use: "under 8 with under 6 recovery", "ALPHA TRADER pro", "Hit & run (set your 
...
Recommended bots to use: "PRIME UNDER pro", "ALPHA TRADER pro", "Hit & run (set your entry point to 8 or 9)". 
...
Recommended bots to use:  "ALPHA TRADER pro", "Hit & run (set your prediction as your entry point)". 
...
ALL THE BEST, SEE YOU AT THE MOON CHAMP!`;
    ...
    link.href = url;
    link.download = "Sold Source code STRATEGIES.pdf";
    ...
    <div className="strategy-viewer">
      <div className="strategy-viewer__toolbar">
        <div className="strategy-viewer__toolbar-left">
          ...
          <button
            className="strategy-viewer__toolbar-btn"
      ...
      <div className="strategy-viewer__content">
        <div className="strategy-viewer__document">
          <h1 className="strategy-viewer__title">
            Sold Source code STRATEGIES
          </h1>
          ...
          <section className="strategy-section">
            ...
            <div className="strategy-subsection">
              <h3 className="strategy-subsection__title">
                EVEN STRATEGY & ENTRY POINT
              </h3>
              <p className="strategy-subsection__digits">
                0,2,4,6 & 8 – Even digits
              </p>
              ...
              <ul className="strategy-list">
                <li>
                  Configure your analysis tool to even/odd and look for a
                  volatility which meets conditions below;
                </li>
                <li>The analysis tool should display 55%+ even win rate.</li>
                <li>
                  Make sure that even "E" dominates on "last 20 digits pattern".
                </li>
                <li>
                  At least one or more even digits should have the highest
                  percentage, represented by a green icon on the even/odd
                  analysis tool.
                </li>
              ...
              <p className="strategy-text">
                Wait for 3+ ODD "O"digits to appear then enter immediately after
                the first EVEN "E" digit occurs.
              </p>
            </div>
            ...
            <div className="strategy-subsection">
              ...
              <ul className="strategy-list">
                ...
                <li>
                  Make sure that ODDs "O" dominates on "last 20 digits pattern".
                </li>
                <li>
                  At least one or more ODD digits should have the highest
                  percentage, represented by a green icon on the even/odd
                  analysis tool.
                </li>
              ...
              <h4 className="strategy-subsection__heading">ENTRY POINT</h4>
              <p className="strategy-text">
                Wait for 3+ EVEN "E"digits to appear then enter immediately
                after the first ODD "O" digit occurs.
              </p>
            </div>
          </section>
          ...
          <section className="strategy-section">
            ...
            <div className="strategy-subsection">
              ...
              <p className="strategy-text">
                Over 1,2 & 3 are considered as the less risky digits best for
                achieving profits consistency.
              </p>
              ...
              <div className="strategy-detail">
                ...
                <ul className="strategy-list">
                  <li>
                    Digit 0 & 1 should have percentages below 10%, one of them
                    being the least appearing digit (represented by a red arc on
                    the over/under analysis tool)
                  </li>
                  <li>
                    Digit 2 to 9 should contain the most appearing digit(s), at
                    least three and above 11%s is an added advantage.
                  </li>
                  <li>
                    The analysis tool configured to over 1 should have at least
                    90%+ win rate and OVERs "O" should dominate the most on
                    "last 20 digits pattern".
                  </li>
                </ul>
                <p className="strategy-bots">
                  Recommended bots to use: "over 1 with over 3 recovery", "ALPHA
                  TRADER pro", "Hit & run (set your entry point to 0)".
                </p>
              </div>
              ...
              <div className="strategy-detail">
                ...
                <ul className="strategy-list">
                  <li>
                    Digit 0,1 & 2 should have percentages below 10%, one of them
                    being the least appearing digit (represented by a red arc on
                    the over/under analysis tool)
                  </li>
                  <li>
                    Digit 3 to 9 should contain the most appearing digit(s), at
                    least three and above 11%s is an added advantage.
                  </li>
                  <li>
                    The analysis tool configured to over 2 should have at least
                    78%+ win rate and OVERs "O" should dominate the most on
                    "last 20 digits pattern".
                  </li>
                </ul>
                <p className="strategy-bots">
                  Recommended bots to use: "QUANTUM OVER pro", "ALPHA TRADER
                  pro", "Hit & run (set your entry point to 0 or 1 )".
                </p>
              </div>

              <h4 className="strategy-subsection__heading">
                ENTRY POINT FOR OVER 1 & 2
              </h4>
              <p className="strategy-text">
                Wait for a single or more UNDER "U" digits on the analysis tool
                then enter immediately after the first OVER "O" appears.
              </p>
              <p className="strategy-note">
                NB: For over digit 3 & 4, use the same concept. Maximum number
                of runs per interval is 3 to 7.
              </p>
            </div>
            ...
            <div className="strategy-subsection">
              ...
              <p className="strategy-text">
                Under 8,7 & 6 are considered as the less risky digits best for
                achieving profits consistency.
              </p>
              ...
              <div className="strategy-detail">
                ...
                <ul className="strategy-list">
                  <li>
                    Digit 9 & 8 should have percentages below 10%, one of them
                    being the least appearing digit (represented by a red arc on
                    the over/under analysis tool)
                  </li>
                  <li>
                    Digit 0 to 7 should contain the most appearing digit(s), at
                    least three and above 11%s is an added advantage.
                  </li>
                  <li>
                    The analysis tool configured to under 8 should have at least
                    90%+ win rate and UNDERs "U" should dominate the most on
                    "last 20 digits pattern".
                  </li>
                </ul>
                <p className="strategy-bots">
                  Recommended bots to use: "under 8 with under 6 recovery",
                  "ALPHA TRADER pro", "Hit & run (set your entry point to 9)".
                </p>
              </div>
              ...
              <div className="strategy-detail">
                ...
                <ul className="strategy-list">
                  <li>
                    Digit 9,8 & 7 should have percentages below 10%, one of them
                    being the least appearing digit (represented by a red arc on
                    the over/under analysis tool)
                  </li>
                  <li>
                    Digit 0 to 6 should contain the most appearing digit(s), at
                    least three and above 11%s is an added advantage.
                  </li>
                  <li>
                    The analysis tool configured to under 7 should have at least
                    78%+ win rate and UNDERs "U" should dominate the most on
                    "last 20 digits pattern".
                  </li>
                </ul>
                <p className="strategy-bots">
                  Recommended bots to use: "PRIME UNDER pro", "ALPHA TRADER
                  pro", "Hit & run (set your entry point to 8 or 9)".
                </p>
              </div>
              ...
              <p className="strategy-text">
                Wait for a single or more OVER "O" digits on the analysis tool
                then enter immediately after the first UNDER "U" appears.
              </p>
            </div>
          </section>
          ...
          <section className="strategy-section">
            ...
            <div className="strategy-subsection">
              ...
              <ul className="strategy-list">
                ...
                <li>
                  The analysis tool configured to matches/differs should show at
                  least 88%+ as differs win rate.
                </li>
              </ul>
              <p className="strategy-text">
                <strong>Entry point:</strong> wait for the predicted digit to be
                hit the enter immediately with the next appearing digit.
              </p>
              <p className="strategy-bots">
                Recommended bots to use: "ALPHA TRADER pro", "Hit & run (set
                your prediction as your entry point)".
              </p>
            </div>
          </section>

          <section className="strategy-section">
            <h2 className="strategy-section__number">
              4. RISE & FALL STRATEGY
            </h2>
            ...
            <div className="strategy-subsection">
              ...
              <p className="strategy-text">
                <strong>Conditions:</strong> Use Bollinger bands & commodity
                channel index (CCI).
              </p>
              <p className="strategy-text">
                <strong>Entry Point:</strong> Wait for an overbought condition
                at the upper band, then enter immediately after a strong sell
                confirmation candle.
              </p>
              <p className="strategy-text">
              ...
              <p className="strategy-text">
                <strong>Risk Management:</strong> Place stop-loss orders just
                above the confirmation candle's low.
              </p>
            </div>
            ...
            <div className="strategy-subsection">
              ...
              <p className="strategy-text">
                <strong>Entry Point:</strong> Wait for an oversold condition at
                the lower band, then enter immediately after a strong buy
                confirmation candle.
              </p>
              <p className="strategy-text">
                <strong>Exit point:</strong> Middle band
              ...
              <p className="strategy-text">
                <strong>Risk Management:</strong> Place stop-loss orders just
                below the confirmation candle's high.
              </p>
              <p className="strategy-bots">
                Recommended bots to use: "ALPHA TRADER pro" & "Dollarmine V1"
              </p>
            </div>
          </section>

          <div className="strategy-footer">
            <p className="strategy-footer__text">
              ALL THE BEST, SEE YOU AT THE MOON CHAMP!
            </p>
          </div>
        </div>
...
export default SoldSourceCodeStrategies;
