        ...
        <div className="strategy-viewer__document">
            ...
            <div className="strategy-subsection">
              <div className="strategy-detail">
                ...
                <p className="strategy-text">
                  Both the green (most appearing) and blue (2nd most appearing)
                  bars must be positioned on odd digits (1, 3, 5, 7, 9) and each
                  should have a percentage of 11% or higher.
                </p>
              </div>
              ...
              <div className="strategy-detail">
                ...
                <p className="strategy-text">
                  Both the red (least appearing) and yellow (2nd least
                  appearing) bars must be positioned on even digits (0, 2, 4, 6,
                  8).
                </p>
              </div>
            </div>
          ...
          <section className="strategy-section">
            ...
            <div className="strategy-subsection">
              <p className="strategy-text">
                <strong>
                  WAIT FOR THE TICK POINTER TO PICK THE LEAST APPEARING DIGIT
                  AMONG THE R & Y,
                </strong>{" "}
                then wait for{" "}
                <strong>
                  CONSECUTIVE 2 ODDS APPEAR WITHIN THE NEXT 5 TICK
                </strong>{" "}
