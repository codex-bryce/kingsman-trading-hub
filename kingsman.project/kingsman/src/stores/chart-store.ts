...
export default class ChartStore {
  ...
  get is_contract_ended() {
    ...
    return (
      transactions.contracts.length > 0 && transactions.contracts[0].is_ended
    );
  }
  ...
  getMarketsOrder = (
    active_symbols: { market: string; display_name: string }[],
  ) => {
