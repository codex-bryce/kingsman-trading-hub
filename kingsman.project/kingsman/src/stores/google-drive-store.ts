...
export default class GoogleDriveStore {
  ...
  constructor(root_store: RootStore) {
    ...
    setTimeout(() => {
      importExternal("https://accounts.google.com/gsi/client").then(() =>
        this.initialiseClient(),
      );
      importExternal("https://apis.google.com/js/api.js").then(() =>
        this.initialise(),
      );
    }, 3000);
  }
